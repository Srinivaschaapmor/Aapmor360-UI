...
function JobOpeningFormSettings({
  updatedMasterData,
  handleClose,
  handleAddItem,
  formErrors,
  ...
  return (
    <Box>
      <Typography sx={{ fontWeight: 600 }}>
        Add Items in the job Opening form
      </Typography>
      <Stack
        direction={"row"}
      ...
      >
        <Box sx={style}>
          <Typography id="modal-modal-title" variant="h6" component="h2">
            Are you sure you want to add itmes to{" "}
            {updatedMasterData.category === "department"
              ? "Department"
              : "Employment Type"}{" "}
          </Typography>
...
export default JobOpeningFormSettings;
